...
Specifically, it will combine detailed information about individual birds and their songs, obtained over the course of three years, to 

@McGregor1981a

to create a multi-generational library of individual bird’s repertoires, characterised at multiple hierarchical levels,

Across bird taxa, the importance of social learning for song production is sparse, and the size of the repertoire
thus acquired varies greatly 42 . Among the obligate social learners, species whose songs are not exclusively
...
\begin{figure}[h]
\ffigbox[\FBwidth]
  {\includegraphics[width=1.45\textwidth, center]{figures/syllable_duration.png}}
  {\caption[Distribution of syllable durations in the dataset]{Kernel density estimation of the distribution of syllable durations for every male in the 2020 dataset.}}
  {\label{fig:durations}}
\end{figure}

\begin{figure}[h]
\ffigbox[\FBwidth]
  {\includegraphics[width=1.45\textwidth, center]{figures/time_plot.png}}
...
\begin{figure}[h]
\ffigbox[\FBwidth]
  {\includegraphics[width=1.45\textwidth, center]{figures/Frequency_distribution_note_types.png}}
...
\begin{figure}[h]
\ffigbox[\FBwidth]
  {\includegraphics[width=1.45\textwidth, center]{figures/n_songs_model_plot.png}}
  {\caption[Regression model of the number of songs recorded]{\textbf{A}: the main parameters in a zero-inflated negative binomial linear regression (ZINB) model with the number of songs recorded for each male as the outcome variable. \textbf{B, C}: plots for each covariate in a ZINB generalized additive model, showing draws from their marginal posterior predictive distributions (blue) and their means (white). The y-axes show a maximum value of 400 to aid visualization.}}
...
\begin{figure}[h]
\ffigbox[\FBwidth]
  {\includegraphics[width=1.45\textwidth, center]{figures/cumulative_plot.png}}
  {\caption[Cumulative plot of song types]{Cumulative number of songs including a note type not previously recorded (y) vs number of songs recorded (x) for every bird in the 2020 dataset with enough notes to allow classification (n = 161).}}
  {\label{fig:posteriors}}
\end{figure}
&nbsp;
...
\begin{figure}[h]
\ffigbox[\FBwidth]
  {\includegraphics[width=1.5\textwidth, center]{figures/transfer_gantt.pdf}}
