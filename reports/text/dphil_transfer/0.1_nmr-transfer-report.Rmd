...
\begin{figure}[h]
  ...
  \caption[A small sample of notes from a male after segmentation and thresholding]{A small sample of notes from a male after segmentation and thresholding.}
...
\begin{figure}[h]
  ...
  \caption[Two different song types sung by a male]{Two different song types sung by a male, with colours corresponding to note types fund using the method outlined above.}
