...
I measured the time from the start of one note in a song to the next, and here’s a plot that shows the relationship between those times for the songs of every bird: blah blah 4/5 ths interval, — consistent with previous evidence for human rhythm categories centered close to, but not exactly on, integers
