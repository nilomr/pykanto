...
Not all birds that learn their songs do so at the same point in their lives or for the same period of time. Some can only learn during the first months after they are born; zebra finch (*Taeniopygia guttata*) juveniles, for example, can only learn and develop their song when they between ~ 20 and 80 days old [@Liu2004]. Other birds can continue to learn and perhaps invent new sounds throughout their lives, like the European starling (*Sturnus vulgaris*). And many birds that disperse early in their lives have a ‘sensitive period’ for learning that extends to the time when they stablish their first territory [@Liu2004; @Beecher2005]. Although this range of variation is often summarised into two categories—open and closed-ended learners—it may be better understood as a spectrum [@Brenowitz2005]. Lastly, there is a fantastic range of variation in repertoire size and complexity. Some birds learn and sing a single song, which they repeat endlessly. Other species, like the brown thrasher (*Toxostoma rufum*), never seem to stop incorporating new sounds to their songs [@Boughey1981].
...
The first chapter will provide an in-depth description of the variability and similarity of great tit songs, from an acoustic and information-theoretic perspective. This will include a very detailed case study from the Wytham population and comparison with data from across the distribution range of the species. It will explore the following questions:

- Are ‘song types’ meaningful categories at larger spatial scales?
- Which song traits are more constrained, and which more free to vary? Is variation stochastic?
- 

## 2. Song learning and learning biases

The second chapter An exploration of the landscape of learning in the study population.
...
. Copying fidelity and convergence in bird song
...
![gantt](/home/nilomr/projects/0.0_great-tit-song/reports/text/gantt.svg)
