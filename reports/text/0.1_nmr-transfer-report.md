...
The process of learning introduces a host of new variables that can influence which songs a bird learns, their structure, and how they change over time.

An extreme consequence of tutor choice is the hybridization that can result from a female pairing with a male of a different species because her father learnt the ‘wrong’ song [@Grant1997; Grant1997a].
...
Conformity is an important aspect of many communication systems in which signals are culturallytransmitted. We suggest that one reason for it to evolve is if nonconforming individuals are discriminated against,
