...
Lastly, there is a fantastic range of variation in repertoire size and complexity. 
...
If a bird learns its song with some accuracy this will typically lead to a pattern where song similarity is correlated with spatial proximity, although the 
