...
def segment_songs(wavfile, DATA_DIR, DT_ID, subset="GRETI_HQ"):
    ...
    if Path(datfile).is_file():
        ...
        for seg in segments:
            ...
            if subset == species:
                ...
                json_dict["indvs"] = {wavfile.parts[-2]: {}}
...
def batch_segment_songs_single(origin, DATA_DIR, DT_ID, subset="GRETI_HQ"):
    ...
    for root, dirs, files in os.walk(str(origin)):
        ...
        for wav in tqdm(
            ...
            if wav.endswith(".wav") or wav.endswith(".WAV") and wav + ".data" in files:
                ...
                segment_songs(wavfile, DATA_DIR, DT_ID, subset=subset)


def batch_segment_songs(origin, DATA_DIR, DT_ID, subset="GRETI_HQ"):
