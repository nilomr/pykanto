...
# ---------------------------------------------------------
#   Read song bout segmentation information from AviaNZ
#   + save .wav files of individual bouts
#   + save .jason files for each bout
# ---------------------------------------------------------


def segment_bouts(wavfile, DATA_PATH, DT_ID, subset="GRETI_HQ"):
...
def batch_segment_bouts_single(origin, DATA_PATH, DT_ID, subset="GRETI_HQ"):
    ...
    for root, dirs, files in os.walk(str(origin)):
        ...
        for wav in tqdm(
            ...
            if wav.endswith(".wav") or wav.endswith(".WAV") and wav + ".data" in files:
                ...
                segment_bouts(wavfile, DATA_PATH, DT_ID, subset=subset)


def batch_segment_bouts(origin, DATA_PATH, DT_ID, subset="GRETI_HQ"):
