...
def segment_songs(wavfile, DATA_DIR, DT_ID, subset="GRETI_HQ", threshold=0):
        ...
        for seg in segments:
            ...
            if subset == species:
                ...
                if float(max(temp)) > threshold:
                    ...
                    json_dict["indvs"] = {wavfile.parts[-2]: {"species": str(species + "placeholder")}}
    ...
    for root, dirs, files in os.walk(str(origin)):
        ...
        for wav in tqdm(
            ...
            if wav.endswith(".wav") or wav.endswith(".WAV") and wav + ".data" in files:
                ...
                segment_songs(wavfile, DATA_DIR, DT_ID, subset=subset, threshold=threshold)
