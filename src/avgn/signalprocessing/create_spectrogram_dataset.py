...
from src.avgn.utils.json import read_json
from src.avgn.utils.audio import load_wav
from PIL import Image
from src.avgn.utils.audio import float32_to_int16, int16_to_float32
import numpy as np
...
def make_spec(
    ...
    if use_tensorflow:
        ...
        from src.avgn.signalprocessing.spectrogramming_tf import spectrogram_tensorflow
    # convert to float
